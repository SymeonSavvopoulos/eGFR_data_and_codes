...
dataset1 = pd.read_csv('D:/Dropbox/eGFR_article_data_algorithms-main/Tables_1_2/organ_valid_no_rej.csv')
dataset2 = pd.read_csv('D:/Dropbox/eGFR_article_data_algorithms-main/Tables_1_2/organ_valid_one_rej.csv')
dataset3 = pd.read_csv('D:/Dropbox/eGFR_article_data_algorithms-main/Tables_1_2/organ_valid_mult_rej.csv')
