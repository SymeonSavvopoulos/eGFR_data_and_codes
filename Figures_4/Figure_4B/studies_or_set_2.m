function [In_max_mean,In_max_std,f1_all]=studies_or_set_2()

A=load('measurements_or_set_2.m');
do_age=load('do_ages_or_set_2.m');
interp_data=load('interp_dat_or_set_2.m');
