function [In_max_mean, In_max_std,f1_all]=studies_mr_set_2()

A=load('measurements_mr_set_2.m');
do_age=load('do_ages_mr_set_2.m');
interp_data=load('interp_dat_mr_set_2.m');
