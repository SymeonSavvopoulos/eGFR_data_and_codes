function [In_min_mean, In_mean, In_max_mean, In_min_std, In_std, In_max_std,f1_all]=studies_set_1()
...
f1_20min(k)=2*x11(k)/(2*x11(k)+x12(k)+x21(k));
...
f1_20(k)=2*x11(k)/(2*x11(k)+x12(k)+x21(k));
end
u20=[xaxis',yaxis'];
