function [In_min_mean,In_mean,In_max_mean,In_min_std,In_std,In_max_std,f1_all]=studies_set_2()

A=load('measurements_set_2.m');
do_age=load('do_ages_set_2.m');
interp_data=load('interp_dat_set_2.m');
