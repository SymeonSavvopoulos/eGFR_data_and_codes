function [In_max_mean,In_max_std,f1_all]=studies_pat_sex_female()

A=load('measurements_pat_sex_female.m');
do_age=load('do_ages_pat_sex_female.m');
interp_data=load('interp_dat_pat_sex_female.m');
XX=size(A);
