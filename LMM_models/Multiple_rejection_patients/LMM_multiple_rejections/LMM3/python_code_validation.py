# -*- coding: utf-8 -*-
"""
Apply 'baseline features + gfr_42days' MixedLM to a validation cohort.

- Loads model_bundle.json saved by training.
- Re-creates engineered RHS feature 'feat_gfr42' from validation file.
- Predicts FE-only or Conditional (BLUP) using observed gfr_42days.
- Saves predictions and (if observed 365 exists) R² / RMSE + scatter plot.
"""
...
EXTERNAL_XLSX = Path(r".../LMM_multiple_rejections/LMM3/validationcohort.xlsx")  # <-- change this
OUT_DIR = Path(r".../LMM_multiple_rejections/LMM3")
...
# Quick sanity print (uncomment if columns don’t match)
# print("Bundle expects:", time_cols_bundle)
# print("Resolved cols:", time_cols)
