function [In_max_mean,In_max_std,f1_all]=studies_pat_age_less50()

A=load('measurements_pat_age_less50.m');
do_age=load('do_ages_pat_age_less50.m');
interp_data=load('interp_dat_pat_age_less50.m');
XX=size(A);
...
prob_min=zeros(343,1);
prob_max=zeros(343,1);
prob=zeros(343,1);
