function [In_max_mean,In_max_std,f1_all]=studies_don_sex_female()

A=load('measurements_don_sex_female.m');
do_age=load('do_ages_don_sex_female.m');
interp_data=load('interp_dat_don_sex_female.m');
XX=size(A);
