function [In_max_mean,In_max_std,f1_all]=studies_don_sex_male()

A=load('measurements_don_sex_male.m');
do_age=load('do_ages_don_sex_male.m');
interp_data=load('interp_dat_don_sex_male.m');
XX=size(A);
